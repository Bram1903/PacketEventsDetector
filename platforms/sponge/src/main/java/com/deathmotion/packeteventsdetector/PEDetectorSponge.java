...
public class PEDetectorSponge {

    private final PluginContainer pluginContainer;

    @Getter
    private final SpongePEDetector ped;

    @Inject
    public PEDetectorSponge(PluginContainer pluginContainer, @ConfigDir(sharedRoot = false) Path configDirectory) {
        this.pluginContainer = pluginContainer;
        this.ped = new SpongePEDetector(configDirectory);
    }
